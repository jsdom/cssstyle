...
exports.shorthandParser = function parse(v, shorthandFor) {
  const obj = {};
  const type = exports.valueType(v);
  if (type === exports.TYPES.NULL_OR_EMPTY_STR) {
...
exports.shorthandSetter = function (property, shorthandFor) {
  return function (v) {
    ...
    const obj = exports.shorthandParser(v, shorthandFor);
    if (obj === undefined) {
      return;
    }
    ...
    const calculated = exports.shorthandGetter(property, shorthandFor).call(this);
    if (calculated !== "") {
