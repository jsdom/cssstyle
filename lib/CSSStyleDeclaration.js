 ...
 * @param {object} context - not in spec, but needed for setting internal flags
 */
...
CSSStyleDeclaration.prototype = {
  ...
  getPropertyValue(name) {
    if (this._values.has(name)) {
      return this._values.get(name).toString();
    }
    return "";
  },
  ...
  removeProperty(property) {
    if (this._readonly) {
      ...
      throw new globalThis.DOMException(msg, "NoModificationAllowedError");
    }
