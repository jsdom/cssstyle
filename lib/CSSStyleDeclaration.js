...
var allProperties = require("./generated/allProperties");
var implementedProperties = require("./generated/implementedProperties");
var { dashedToCamelCase } = require("./utils/camelize");
...
Object.defineProperties(CSSStyleDeclaration.prototype, {
  cssText: {
    ...
    set: function (value) {
      ...
      var name;
      for (var i = 0; i < dummyRule.length; ++i) {
        name = dummyRule[i];
        this.setProperty(
          dummyRule[i],
