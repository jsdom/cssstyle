...
class CSSStyleDeclaration {
  ...
  /**
   * Clears all indexed properties and resets length to 0.
   *
   * @private
   */
  ...
  /**
   * Removes an indexed property at the specified index and shifts others.
   *
   * @private
  ...
  _setProperty(property, value, priority) {
    ...
    let originalText = "";
    if (typeof this._onChange === "function" && !this._updating) {
