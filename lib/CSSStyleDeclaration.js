...
const { hasVarFunc, parseKeyword, parseShorthand, prepareValue } = require("./parsers");
...
Object.defineProperties(CSSStyleDeclaration.prototype, {
  ...
  // If one value, it applies to all.
  // If two, the first applies to the top and bottom, and the second to right
  // and left.
  // If three, the first applies to the top, the second to right and left,
  // the third to bottom.
