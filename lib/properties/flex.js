  ...
  if (Array.isArray(value) && value.length) {
    if (value.length === 1) {
      ...
      switch (type) {
        case "Calc": {
          if (isNumber) {
            return `${name}(${itemValue}) 1 0%`;
          }
          return `1 1 ${name}(${itemValue})`;
        }
        case "Dimension": {
...
module.exports.definition = {
  set(v) {
    ...
    if (parsers.hasVarFunc(v)) {
      this._shorthandSetter(property, "", "", module.exports.shorthandFor);
      ...
      this._shorthandSetter(property, val, priority, module.exports.shorthandFor);
  ...
  get() {
    ...
    const subVal = this._shorthandGetter(property, module.exports.shorthandFor);
