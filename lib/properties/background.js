...
module.exports.parse = function parse(v, opt = {}) {
  ...
  for (let i = 0; i < l; i++) {
    let bg = {
      "background-image": module.exports.initialValues.get("background-image"),
      "background-position": module.exports.initialValues.get("background-position"),
      "background-size": module.exports.initialValues.get("background-size"),
      "background-repeat": module.exports.initialValues.get("background-repeat"),
      "background-origin": module.exports.initialValues.get("background-origin"),
      "background-clip": module.exports.initialValues.get("background-clip"),
      "background-attachment": module.exports.initialValues.get("background-attachment"),
      "background-color": module.exports.initialValues.get("background-color")
    };
    if (l > 1 && i !== l - 1) {
      bg = {
        "background-image": module.exports.initialValues.get("background-image"),
