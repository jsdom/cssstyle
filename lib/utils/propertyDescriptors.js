 ...
 * used whenever we don't have a specific handler in `./properties/*.js`. They perform some basic logic that works as a
 * fallback, and is correct for simple properties, but properties with more complex grammars will need their own
 * handlers.
 *
 * @param {string} property - The canonical CSS property name (e.g. "backdrop-filter", not "backdropFilter").
 * @returns {Object} The property descriptor object to be installed on the `CSSStyleDeclaration` class.
 */
