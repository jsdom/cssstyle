...
describe('CSSStyleDeclaration', () => {
  ...
  test('top, left, right, bottom properties should accept "auto"', () => {
    var style = new CSSStyleDeclaration();
    style.cssText = `top: auto; right: auto; bottom: auto; left: auto;`;
    expect(style.top).toEqual('auto');
    expect(style.right).toEqual('auto');
    expect(style.bottom).toEqual('auto');
    expect(style.left).toEqual('auto');
  });
