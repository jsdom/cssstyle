...
describe('properties', () => {
  ...
  describe('border', () => {
    test('shorthand propagates to longhands', () => {
      ...
      // none
      // TOFIX: the following expectations are all wrong
      style.borderTopWidth = '1px';
      expect(style.cssText).toBe('border-top-width: 1px;');
      style.border = 'none';
      expect(style.cssText).toBe('');
      ...
      expect(style.cssText).toBe('border-top-width: 1px; border-left-width: 1px;');
      style.borderTop = 'none';
      expect(style.cssText).toBe('border-left-width: 1px;');
    });
  });
  ...
  describe('flex', () => {
    test('shorthand propagates to longhands', () => {
      ...
      expect(style.getPropertyValue('flex-grow')).toBe('');
      expect(style.getPropertyValue('flex-shrink')).toBe('');
      expect(style.getPropertyValue('flex-basis')).toBe('auto');
      style.removeProperty('flex');
      ...
      expect(style.getPropertyValue('flex-shrink')).toBe('');
      expect(style.getPropertyValue('flex-basis')).toBe('');
      style.removeProperty('flex');
