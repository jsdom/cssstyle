...
function toCamelCase(propName) {
  return propName.replace(/-([a-z])/g, function (g) { return g[1].toUpperCase(); })
}
...
request(url, function (error, response, body) {
  if (!error && response.statusCode === 200) {
    ...
    var out_file = fs.createWriteStream(path.resolve(__dirname, './../tests/css_property_names.js'), {encoding: 'utf-8'});
    ...
    validPropertiesStatements.push(
      t.expressionStatement(
        t.assignmentExpression(
          ...
          t.arrayExpression(CSSpropertyNames.map(function (cssProp) {
